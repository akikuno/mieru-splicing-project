...
ggsave("reports/Fig3/025-violinplot.pdf", g_violinplot, width = 24, height = 6, family = "Arial", device = cairo_pdf)
ggsave("reports/Fig3/025-violinplot.jpg", g_violinplot, width = 24, height = 6)

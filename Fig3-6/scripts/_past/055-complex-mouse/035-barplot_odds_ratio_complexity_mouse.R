...
# ヒトとマウスの複合体
###############################################################################
results_fisher <- read_csv("reports/Fig5/fisher_complextab_mouse.csv")
...
ggsave("reports/Fig5/barplot_odds_complextab_mouse.jpg", g_barplot, width = 15, height = 8)
ggsave("reports/Fig5/barplot_odds_complextab_mouse.pdf", g_barplot, width = 15, height = 8)
